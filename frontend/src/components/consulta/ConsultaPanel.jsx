// @module consulta/ConsultaPanel — Conteúdo da Consulta Rápida (abas, busca, resultado, ações)
// Reutilizado pelo FAB flutuante (ConsultaModal) e pela página integrada (ConsultaPage).
...
export default function ConsultaPanel({ autoFocus = true }) {
