...
import {
  ...
  Tractor, Wheat, Beef, Wrench, Car, Package, Shield
} from 'lucide-react';
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-gray-600">
            Laudos conforme NBR 14.653 (partes 3 e 5) — rurais, grãos, bovinos, equipamentos e mais.
          </p>
        </div>
        <Button
            ...
            return (
              ...
              >
                ...
                <div className="font-semibold text-gray-900 mt-2 line-clamp-1">
                  {g.descricao_bem || g.municipio || '(sem descrição)'}
                </div>
                <div className="text-xs text-gray-500 mt-0.5 line-clamp-1">
                  {g.solicitante?.nome || '—'}{g.municipio ? ` · ${g.municipio}/${g.uf}` : ''}
                </div>

                <div className="mt-4 pt-4 border-t border-gray-100 space-y-1.5">
                  <div className="flex items-center gap-1.5 text-xs text-gray-600">
                    <DollarSign className="w-3 h-3" />
                    {fmtCurrency(g.valor_total)}
                  </div>
