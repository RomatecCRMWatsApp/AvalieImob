            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
                <div className="bg-gray-50 border border-gray-200 rounded-lg p-3 text-center">
                  ...
                  <div className="text-base font-bold text-gray-800">
                    R$ {Number(form.ponderancia_limite_inf || 0).toLocaleString('pt-BR', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}/m²
                  </div>
                </div>
                <div className="bg-gray-50 border border-gray-200 rounded-lg p-3 text-center">
                  <div className="text-xs text-gray-500 uppercase tracking-wider mb-1">Limite Superior</div>
                  <div className="text-base font-bold text-gray-800">
                    R$ {Number(form.ponderancia_limite_sup || 0).toLocaleString('pt-BR', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}/m²
                  </div>
                </div>
              ...
              <div className="bg-emerald-50 border-2 border-emerald-300 rounded-xl p-5">
                ...
                <div className="text-3xl font-bold text-emerald-900 mb-1">
                  Média Ponderada Final: R$ {Number(form.ponderancia_media || 0).toLocaleString('pt-BR', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}/m²
                </div>
              </div>
