...
const PtamList = () => {
  ...
  const tipoAvaliacaoBadge = (tipo) => {
    if (tipo === 'locacao') return 'bg-blue-100 text-blue-800';
    return 'bg-emerald-100 text-emerald-800';
  };

  const tipoAvaliacaoLabel = (tipo) => {
            ...
            <div key={p.id} className="bg-white rounded-xl border border-gray-200 p-5 hover:shadow-md transition">
              <div className="flex items-start justify-between mb-3">
                ...
                <div className="flex gap-1.5 flex-wrap justify-end">
                  <Badge className={tipoAvaliacaoBadge(p.tipo_avaliacao)}>{tipoAvaliacaoLabel(p.tipo_avaliacao)}</Badge>
