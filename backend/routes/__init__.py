...
from routes.testemunhas import router as testemunhas_router
...
from routes.assinatura_externa import (
...
from routes.inferencia import router as inferencia_router
